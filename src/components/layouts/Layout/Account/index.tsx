...
import Account_Template from "@components/templates/Account";
...
interface Props {
 ...
 const Account_Layout: FC<Props> = ({ user, imgProfile }) => {
    ...
    return (
        <>
            ...
            <Box sx={{padding: {xs:1, md:10}}} component="main" justifyContent="center" >
                <Account_Template imgProfile={imgProfile} user={user} />
            </Box>
