...
import SocialNetworks_Template from "@components/templates/Account/social_networks";
...
interface Props {
 ...
 const SocialNetworks_Layout: FC<Props> = ({ user}) => {
...
export default SocialNetworks_Layout;