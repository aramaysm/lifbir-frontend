...
import SocialNetworks_Layout from "@components/layouts/Layout/Account/social_networks";
...
interface ParamsSocialNetworks {
    user: {
        username: string,
        name:string
    };
...
export default function Social_Networks({ user }: ParamsSocialNetworks) {
